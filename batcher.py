...
class GenBatcher(object):
    def __init__(self, vocab, hps):
        ...
        self.train_queue = self.fill_example_queue("new_data/student_collect_data.csv", mode ="train")
        self.test_queue = self.fill_example_queue("new_data/student_collect_data.csv",  mode ="test")
